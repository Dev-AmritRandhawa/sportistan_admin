...
import 'package:sportistan_admin/screens/book_a_slot.dart';
import 'package:sportistan_admin/screens/book_entire_day.dart';
import 'package:sportistan_admin/screens/nav_slot_setting.dart';
import 'package:sportistan_admin/widgets/page_router.dart';

class ManageGround extends StatefulWidget {
  ...
  const ManageGround({super.key,
    required this.groundID,
    required this.groundName,
    required this.groundAddress,
    required this.groundType, required this.refID, required this.onwards});

  @override
  State<ManageGround> createState() => _ManageGroundState();
}

class _ManageGroundState extends State<ManageGround> {
            ...
            child: Column(
              children: [
                Card(child: Padding(
                  ...
                  child: Column(
                    children: [
                      Text(widget.groundName, style: const TextStyle(
                          fontWeight: FontWeight.bold, fontSize: 18)),
                      Text(widget.groundAddress, style: const TextStyle(
